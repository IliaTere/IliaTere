...
<picture>
  ...
  <img alt="github-snake" src="https://raw.githubusercontent.com/IliaTere/IliaTere/refs/heads/output/github-contribution-grid-snake.svg" />
</picture>
...
Студент мехмата МГУ (вычислительная математика). Разрабатываю backend-сервисы для высоконагруженных систем, интегрирую математические алгоритмы, проектирую процессы ИБ для объектов КИИ.
